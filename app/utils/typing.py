...
class InputChat(BaseModel):
    ...
    answer: str | None = Field(
        None,
        description="The answer generated by the chat model.",
    )
    original_query: HumanMessage | None = Field(
        None,
        description="The original question of the user.",
    )
    request:AIMessage | None = Field(None, description="The request made from a node to a node."
    )
    answer_source: str | None = Field(
        None,
        description="The source of the answer, such as 'search' or 'knowledge_base'.",
    )
    trys: int = Field(
        0,
